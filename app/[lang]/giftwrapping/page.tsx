...
export default function GiftWrapping({ params }: { params: { lang: string, data: any} }) {
    ...
    return (
        <>
            <MobileHeader type="Third"  lang={params.lang} pageTitle={params.lang === 'ar' ? 'تغليف الهدايا' : 'Gift Wrapping'} />
            <div className="container py-16 md:py-4">
                <div className="my-2">
                    <h1 className=" font-semibold text-base 2xl:text-lg">{params.lang == 'ar' ? 'الاسئلة والاجوبة' : 'Gift Wrapping'}</h1>
