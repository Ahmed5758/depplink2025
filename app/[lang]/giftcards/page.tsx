...
export default function GiftCards({ params, searchParams }: { params: { lang: string, data: any, devicetype: any }, searchParams: any }) {
    ...
    return (
        <>
            <MobileHeader type="Third" lang={params.lang} pageTitle={params.lang == 'ar' ? 'بطاقات الهدايا' : 'Gift Cards'} />
            <div className="container py-4 max-md:pt-20">
                <div className="md:my-8 mx-auto">
                    <div className="flex items-center gap-x-3 text-base font-semibold w-full">
                        <h2 className="md:w-[480px] w-1/2">{params?.lang === 'ar' ? "الثيم المحدد" : "Selected theme"}</h2>
                        <h3 className="md:w-full md:pl-2 w-1/2 rtl:text-left ltr:text-right">{params?.lang === 'ar' ? "تفاصيل بطاقة الهدايا" : "Gift Card Details"}</h3>
                    </div>
                    <div className="md:flex items-start gap-x-3 mt-3">
                        ...
                        <div className="w-full max-md:mt-4">
                            <div className="mb-3">
                                <h3 className="text-sm font-medium mb-2">{params?.lang === 'ar' ? "الثيم المحدد" : "Selected theme"}</h3>
                            ...
                            <div className="mb-3">
                                <h3 className="text-sm font-medium mb-2">{params?.lang === 'ar' ? "حدد المبلغ" : "Select amount"}</h3>
                                <div className="flex items-center gap-x-3">
                                    <button
                            ...
                            <div className="mb-3">
                                <div className="mt-3 flex items-center gap-x-2">
                                    ...
                                    <label className="text-sm font-medium text-[#344054]" htmlFor='myself'>{params.lang === 'ar' ? 'بشتريها لنفسي' : 'Buying for myself'}</label>
                                </div>
                            </div>
                                ...
                                <div className=''>
                                    ...
                                    <div className="border border-[#dfdfdf70] focus-visible:outline-none hover:border-[#004B7A] bg-white rounded p-2">
                                        <div className="flex items-center gap-3 fill-[#004B7A]">
                                            ...
                                            <input id="iconLeft" type="text" placeholder={params.lang == 'ar' ? 'الاسم بالكامل' : 'Full Name'} className="text-xs focus-visible:outline-none w-full" value={mySelf ? userName : receiverName} onChange={(e) => {
                                ...
                                <div className='mt-2'>
                                    ...
                                    <div className="border border-[#dfdfdf70] focus-visible:outline-none hover:border-[#004B7A] bg-white rounded p-2">
                                        <div className="flex items-center gap-3 fill-[#004B7A]">
                                            ...
                                            <input id="iconLeft" type="text" placeholder={params.lang == 'ar' ? 'بريد إلكتروني' : 'E-mail'} className="text-xs focus-visible:outline-none w-full" value={mySelf ? userEmail : receiverEmail} onChange={(e) => {
