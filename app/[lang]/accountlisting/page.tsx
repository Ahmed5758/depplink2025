    ...
    const deleteUser = () => {
        ...
        post('userDelete', data).then(async (responseJson: any) => {
            if (responseJson?.success) {
                ...
                topMessageAlartDanger(params.lang === 'ar' ? "لقد تم حذف حسابك!" : "Your account has been deleted!")
                handleLogout()
            }
            else {
                setConfirmationPopup(false)
            ...
            <div className="py-16 md:py-4">
                <div className="container">
                    <Link href={`${origin}/${params?.lang}/account/profile`} className="bg-white shadow-md rounded-md p-3 flex items-center gap-3">
                        ...
                        <div className="">
                            <label className="text-sm font-medium">{params.lang === 'ar' ? 'مرحباً' : 'Welcome'}</label>
                            {userid ?
                ...
                </Link>
                {
                    ...
                    <Link href={`${origin}/${params?.lang}/projectsales`} className="border-b border-[#9CA4AB50] pl-3 pr-4 py-3 flex items-center justify-between text-[#004B7A] fill-[#004B7A]">
                        <div className="flex items-center gap-1">
                            <svg width={33} viewBox="0 0 24.00 24.00" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#000000" stroke-width="0.00024000000000000003"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round" stroke="#CCCCCC" stroke-width="0.43200000000000005"></g><g id="SVGRepo_iconCarrier"> <path fillRule="evenodd" clip-rule="evenodd" d="M6.75 6L7.5 5.25H16.5L17.25 6V19.3162L12 16.2051L6.75 19.3162V6ZM8.25 6.75V16.6838L12 14.4615L15.75 16.6838V6.75H8.25Z" fill="#004B7A"></path> </g></svg>
                            <h2 className="text-sm font-semibold">{params.lang === 'ar' ? 'مبيعات المشاريع' : 'Project Sales'}</h2>
                        </div>
                        <svg height="26" viewBox="0 0 24 24" width="26" className={params?.lang === 'ar' ? "" : "rotate-180"} xmlns="http://www.w3.org/2000/svg" id="fi_2722991"><g id="_17" data-name="17"><path d="m15 19a1 1 0 0 1 -.71-.29l-6-6a1 1 0 0 1 0-1.41l6-6a1 1 0 0 1 1.41 1.41l-5.29 5.29 5.29 5.29a1 1 0 0 1 -.7 1.71z"></path></g></svg>
                    </Link>
                    <Link href={`${origin}/${params?.lang}/maintenance`} className="border-b border-[#9CA4AB50] px-4 py-3 flex items-center justify-between text-[#004B7A] fill-[#004B7A]">
                        <div className="flex items-center gap-x-2">
                            <svg viewBox="0 0 24 24" width={23} fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path fillRule="evenodd" clip-rule="evenodd" d="M9.29289 1.29289C9.48043 1.10536 9.73478 1 10 1H18C19.6569 1 21 2.34315 21 4V20C21 21.6569 19.6569 23 18 23H6C4.34315 23 3 21.6569 3 20V8C3 7.73478 3.10536 7.48043 3.29289 7.29289L9.29289 1.29289ZM18 3H11V8C11 8.55228 10.5523 9 10 9H5V20C5 20.5523 5.44772 21 6 21H18C18.5523 21 19 20.5523 19 20V4C19 3.44772 18.5523 3 18 3ZM6.41421 7H9V4.41421L6.41421 7ZM7 13C7 12.4477 7.44772 12 8 12H16C16.5523 12 17 12.4477 17 13C17 13.5523 16.5523 14 16 14H8C7.44772 14 7 13.5523 7 13ZM7 17C7 16.4477 7.44772 16 8 16H16C16.5523 16 17 16.4477 17 17C17 17.5523 16.5523 18 16 18H8C7.44772 18 7 17.5523 7 17Z" fill="#004B7A"></path> </g></svg>
                            <h2 className="text-sm font-semibold">{params.lang === 'ar' ? 'طلبات الصيانة' : 'Maintainance Request'}</h2>
                        </div>
                        <svg height="26" viewBox="0 0 24 24" width="26" className={params?.lang === 'ar' ? "" : "rotate-180"} xmlns="http://www.w3.org/2000/svg" id="fi_2722991"><g id="_17" data-name="17"><path d="m15 19a1 1 0 0 1 -.71-.29l-6-6a1 1 0 0 1 0-1.41l6-6a1 1 0 0 1 1.41 1.41l-5.29 5.29 5.29 5.29a1 1 0 0 1 -.7 1.71z"></path></g></svg>
                    </Link>
                    <Link href={`${origin}/${params?.lang}/store-locatore`} className="border-b border-[#9CA4AB50] px-4 py-3 flex items-center justify-between text-[#004B7A] fill-[#004B7A]">
                        <div className="flex items-center gap-1">
                            <svg viewBox="0 0 24 24" width={23} fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M12 21C15.5 17.4 19 14.1764 19 10.2C19 6.22355 15.866 3 12 3C8.13401 3 5 6.22355 5 10.2C5 14.1764 8.5 17.4 12 21Z" stroke="#004B7A" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path> <path d="M12 12C13.1046 12 14 11.1046 14 10C14 8.89543 13.1046 8 12 8C10.8954 8 10 8.89543 10 10C10 11.1046 10.8954 12 12 12Z" stroke="#004B7A" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path> </g></svg>
                            <h2 className="text-sm font-semibold">{params.lang === 'ar' ? 'فروع تمكين' : 'Tamkeen Showrooms'}</h2>
                        </div>
                        <svg height="26" viewBox="0 0 24 24" width="26" className={params?.lang === 'ar' ? "" : "rotate-180"} xmlns="http://www.w3.org/2000/svg" id="fi_2722991"><g id="_17" data-name="17"><path d="m15 19a1 1 0 0 1 -.71-.29l-6-6a1 1 0 0 1 0-1.41l6-6a1 1 0 0 1 1.41 1.41l-5.29 5.29 5.29 5.29a1 1 0 0 1 -.7 1.71z"></path></g></svg>
                    </Link>
                    <Link href={`${origin}/${params?.lang}/faqs`} className="border-b border-[#9CA4AB50] px-4 py-3 flex items-center justify-between text-[#004B7A] fill-[#004B7A]">
                        <div className="flex items-center gap-x-2">
                            <svg viewBox="0 0 24 24" width={23} fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M12 22C17.5228 22 22 17.5228 22 12C22 6.47715 17.5228 2 12 2C6.47715 2 2 6.47715 2 12C2 17.5228 6.47715 22 12 22Z" stroke="#004B7A" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path> <path d="M9 9C9 5.49997 14.5 5.5 14.5 9C14.5 11.5 12 10.9999 12 13.9999" stroke="#004B7A" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path> <path d="M12 18.01L12.01 17.9989" stroke="#004B7A" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path> </g></svg>
                            <h2 className="text-sm font-semibold">{params.lang === 'ar' ? 'الأسئلة الشائعة' : 'FAQs'}</h2>
                        </div>
                        <svg height="26" viewBox="0 0 24 24" width="26" className={params?.lang === 'ar' ? "" : "rotate-180"} xmlns="http://www.w3.org/2000/svg" id="fi_2722991"><g id="_17" data-name="17"><path d="m15 19a1 1 0 0 1 -.71-.29l-6-6a1 1 0 0 1 0-1.41l6-6a1 1 0 0 1 1.41 1.41l-5.29 5.29 5.29 5.29a1 1 0 0 1 -.7 1.71z"></path></g></svg>
                    </Link>
                    <Link href={`${origin}/${params?.lang}/contact-us`} className="border-b border-[#9CA4AB50] px-4 py-3 flex items-center justify-between text-[#004B7A] fill-[#004B7A]">
                        <div className="flex items-center gap-x-2">
                            <svg viewBox="0 0 24 24" width={23} fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <g clip-path="url(#clip0_429_11119)"> <path d="M21 15V12C21 7.02944 16.9706 3 12 3C7.02944 3 3 7.02944 3 12V15" stroke="#004B7A" stroke-width="2.5" stroke-linecap="round"></path> <path d="M3 15H6C6.55228 15 7 15.4477 7 16V19C7 20.1046 6.10457 21 5 21V21C3.89543 21 3 20.1046 3 19V15Z" stroke="#004B7A" stroke-width="2.5" stroke-linecap="round"></path> <path d="M17 16C17 15.4477 17.4477 15 18 15H21V19C21 20.1046 20.1046 21 19 21V21C17.8954 21 17 20.1046 17 19V16Z" stroke="#004B7A" stroke-width="2.5" stroke-linecap="round"></path> </g> <defs> <clipPath id="clip0_429_11119"> <rect width="24" height="24" fill="white"></rect> </clipPath> </defs> </g></svg>
                            <h2 className="text-sm font-semibold">{params.lang === 'ar' ? 'اتصل بنا' : 'Call Us'}</h2>
                        </div>
                        <svg height="26" viewBox="0 0 24 24" width="26" className={params?.lang === 'ar' ? "" : "rotate-180"} xmlns="http://www.w3.org/2000/svg" id="fi_2722991"><g id="_17" data-name="17"><path d="m15 19a1 1 0 0 1 -.71-.29l-6-6a1 1 0 0 1 0-1.41l6-6a1 1 0 0 1 1.41 1.41l-5.29 5.29 5.29 5.29a1 1 0 0 1 -.7 1.71z"></path></g></svg>
                    </Link>
                    <Link href={`${origin}/${params?.lang}/terms-and-conditions`} className="border-b border-[#9CA4AB50] px-4 py-3 flex items-center justify-between text-[#004B7A] fill-[#004B7A]">
                        <div className="flex items-center gap-x-2">
                            <svg viewBox="0 0 512 512" width={23} version="1.1" xmlns="http://www.w3.org/2000/svg" fill="#004B7A"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <title>about</title> <g id="Page-1" stroke="none" stroke-width="1" fill="none" fillRule="evenodd"> <g id="about-white" fill="#004B7A" transform="translate(42.666667, 42.666667)"> <path d="M213.333333,3.55271368e-14 C95.51296,3.55271368e-14 3.55271368e-14,95.51168 3.55271368e-14,213.333333 C3.55271368e-14,331.153707 95.51296,426.666667 213.333333,426.666667 C331.154987,426.666667 426.666667,331.153707 426.666667,213.333333 C426.666667,95.51168 331.154987,3.55271368e-14 213.333333,3.55271368e-14 Z M213.333333,384 C119.227947,384 42.6666667,307.43872 42.6666667,213.333333 C42.6666667,119.227947 119.227947,42.6666667 213.333333,42.6666667 C307.44,42.6666667 384,119.227947 384,213.333333 C384,307.43872 307.44,384 213.333333,384 Z M240.04672,128 C240.04672,143.46752 228.785067,154.666667 213.55008,154.666667 C197.698773,154.666667 186.713387,143.46752 186.713387,127.704107 C186.713387,112.5536 197.99616,101.333333 213.55008,101.333333 C228.785067,101.333333 240.04672,112.5536 240.04672,128 Z M192.04672,192 L234.713387,192 L234.713387,320 L192.04672,320 L192.04672,192 Z" id="Shape"> </path> </g> </g> </g></svg>
                            <h2 className="text-sm font-semibold">{params?.lang == 'ar' ? 'الشروط والاحكام' : 'Terms & Conditions'}</h2>
                        </div>
                        <svg height="26" viewBox="0 0 24 24" width="26" className={params?.lang === 'ar' ? "" : "rotate-180"} xmlns="http://www.w3.org/2000/svg" id="fi_2722991"><g id="_17" data-name="17"><path d="m15 19a1 1 0 0 1 -.71-.29l-6-6a1 1 0 0 1 0-1.41l6-6a1 1 0 0 1 1.41 1.41l-5.29 5.29 5.29 5.29a1 1 0 0 1 -.7 1.71z"></path></g></svg>
                    </Link>
                    <Link href={`${origin}/${params?.lang}/repalcement-and-retrieval-policy`} className="border-b border-[#9CA4AB50] px-4 py-3 flex items-center justify-between text-[#004B7A] fill-[#004B7A]">
                        <div className="flex items-center gap-x-2">
                            <svg viewBox="0 0 512 512" width={23} version="1.1" xmlns="http://www.w3.org/2000/svg" fill="#004B7A"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <title>about</title> <g id="Page-1" stroke="none" stroke-width="1" fill="none" fillRule="evenodd"> <g id="about-white" fill="#004B7A" transform="translate(42.666667, 42.666667)"> <path d="M213.333333,3.55271368e-14 C95.51296,3.55271368e-14 3.55271368e-14,95.51168 3.55271368e-14,213.333333 C3.55271368e-14,331.153707 95.51296,426.666667 213.333333,426.666667 C331.154987,426.666667 426.666667,331.153707 426.666667,213.333333 C426.666667,95.51168 331.154987,3.55271368e-14 213.333333,3.55271368e-14 Z M213.333333,384 C119.227947,384 42.6666667,307.43872 42.6666667,213.333333 C42.6666667,119.227947 119.227947,42.6666667 213.333333,42.6666667 C307.44,42.6666667 384,119.227947 384,213.333333 C384,307.43872 307.44,384 213.333333,384 Z M240.04672,128 C240.04672,143.46752 228.785067,154.666667 213.55008,154.666667 C197.698773,154.666667 186.713387,143.46752 186.713387,127.704107 C186.713387,112.5536 197.99616,101.333333 213.55008,101.333333 C228.785067,101.333333 240.04672,112.5536 240.04672,128 Z M192.04672,192 L234.713387,192 L234.713387,320 L192.04672,320 L192.04672,192 Z" id="Shape"> </path> </g> </g> </g></svg>
                            <h2 className="text-sm font-semibold">{params.lang === 'ar' ? 'سياسة الاستبدال و الاسترجاع' : 'Exchange & Return Policy'}</h2>
                        </div>
                        <svg height="26" viewBox="0 0 24 24" width="26" className={params?.lang === 'ar' ? "" : "rotate-180"} xmlns="http://www.w3.org/2000/svg" id="fi_2722991"><g id="_17" data-name="17"><path d="m15 19a1 1 0 0 1 -.71-.29l-6-6a1 1 0 0 1 0-1.41l6-6a1 1 0 0 1 1.41 1.41l-5.29 5.29 5.29 5.29a1 1 0 0 1 -.7 1.71z"></path></g></svg>
                    </Link>
                    ...
                    {localStorage.getItem("userid") ?
                        <>
                            ...
                            {/* <button onClick={() => setConfirmationPopup(true)} className="mt-2 focus-visible:outline-none btn border border-[#004B7A] hover:bg-[#004B7A] text-[#004B7A] p-2.5 rounded-md w-full hover:text-white fill-white flex items-center justify-center font-medium gap-x-2">
                                {params.lang === 'ar' ? 'حذف حسابك' : 'Delete Your Account'}
                            </button> */}
                        </>
                        :
                            ...
                            >
                                <Dialog.Panel as="div" className="panel border-0 p-5 rounded-lg overflow-hidden w-full h-auto max-w-5xl my-8 text-black bg-white relative">
                                    ...
                                    <div className="text-center">
                                        <h2 className="text-md font-semibold">{params.lang === 'ar' ? 'هل تريد حذف هذا الحساب؟' : 'Do you want to delete this account?'}</h2>
