...
export default function LoyaltyPoints({ params }: { params: { lang: string, data: any, devicetype: any } }) {
    ...
    return (
        <>
                <MobileHeader type="Third"  lang={params.lang} pageTitle={params.lang === 'ar' ? 'نقاط الولاء' : 'Loyalty Points'} />
