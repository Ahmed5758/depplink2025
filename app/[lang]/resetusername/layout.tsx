...
export async function generateMetadata({ params }: Props, parent: ResolvingMetadata): Promise<Metadata> {
    return {
        title: 'Reset Username | Tamkeen Stores',
        description: 'qaiser',
        ...
        openGraph: {
            siteName: `Reset Username | Tamkeen Stores`,
            title: `Reset Username | Tamkeen Stores`,
            description: '',
            locale: params.lang,
            type: 'website',
...
export default async function resetUsernameLayout({ children, params }: { children: React.ReactNode, params: {slug: string, data: any, lang: string } }) {
    const jsonLd = [
        {
            "@id": "#breadcrumb",
            ...
            itemListElement: [
                ...
                },
                {
                    ...
                    position: 2,
                    name: "resetUsername",
                    item: "https://tamkeenstores.com.sa/" + params.lang + "/resetusername",
                },
            ],
        },
    ]
