                                        ...
                                        <div className="text-sm font-medium flex items-center justify-between">
                                            <div>
                                                ...
                                                <div className="flex items-center gap-x-2 mt-1 rtl:mt-2 text-[#004B7A] text-xs">
                                                    <label>
                                                        {
                                                            paymentMethod == 'tamara' ? params.lang == 'ar' ? `غدا تقسيط علي 12 شهور بمبلغ ${Intl.NumberFormat('en-US').format(summary?.filter((element: any) => element.key == 'total')[0]?.price / 12)} ريال في الشهر` : `Installments for 12 months at an amount of ${Intl.NumberFormat('en-US').format(summary?.filter((element: any) => element.key == 'total')[0]?.price / 12)} per month`
