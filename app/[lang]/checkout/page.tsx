...
export default function Checkout({ params }: { params: { lang: string, devicetype: any } }) {
    ...
    useEffect(() => {
        if (addressid) {
            ...
            (async () => {
                var city: string = isArabic ? globalStore?.waybill_city_data?.name_arabic : globalStore?.waybill_city_data?.name
                await setDiscountRule(city);
                await setDiscountRuleBogo(city);
            })();
        }
    ...
    const expressDelivery = async () => {
        ...
        if(cartData?.storeType == 0 && cartData?.storeId == false){
            ...
            city= isArabic ? globalStore?.waybill_city_data?.name_arabic : globalStore?.waybill_city_data?.name
        }
                                        ...
                                        <div className={`w-full ${addAddress == true ? 'block' : 'hidden'}`}>
                                            ...
                                            <div className={`pb-3 ${addAddress == true ? 'block' : 'hidden'}`}>
                                                <div className="flex items-center rounded-md border border-[#dfdfdf] focus-visible:outline-[#004B7A] fill-primary pb-3 pt-2.5 px-3 text-sm gap-x-3 w-full mb-3 bg-white">
                                                    ...
                                                    <input id="iconLeft" value={address} type="text" 
                                                    placeholder={
                                                        params.lang == "ar"
                                                            ? "اسم الحي / اسم الشارع / اقرب معلم / رقم الدور"
                                                            : "District Name / Floor Number / Area Name / Land Mark"
                                                    }
                                                    className="focus-visible:outline-none w-full font-regular"
                                                        onChange={(e: any) => {
                                                                        ...
                                                                        <div className="flex items-center gap-x-3 w-full">
                                                                            ...
                                                                            <div className="w-full">
                                                                                <RadioGroup.Label as="p" className={`text-sm font-bold  mb-3 text-white`}>
                                                                                    {addressData?.filter((item: any) => item?.id == addressid)[0]?.address_label == 0 ? params.lang == 'ar' ? 'الــمنـــزل' : 'Home' : params.lang == 'ar' ? 'مكتب' : 'Office'}
                                                                        ...
                                                                        <div className="flex w-full items-center justify-between">
                                                                            <div className="flex items-center gap-x-3 w-full">
                                                                                ...
                                                                                <div className="w-full">
                                                                                    ...
                                                                                    <p className={`mt-1 text-xs text-white`}>{params?.lang == 'ar' ? globalStore?.showroom_arabic : globalStore?.showroom}</p>
                                                                                    <p className={`mt-1 text-xs text-white`}>{params?.lang == 'ar' ? globalStore?.showroom_address_arabic : globalStore?.showroom_address} | 8002444464</p>
                                                                                    <p className={`mt-1.5 text-xs font-bold text-white`}>{params.lang == 'ar' ? globalStore?.waybill_city_data?.name_arabic : globalStore?.waybill_city_data?.name}, {params.lang == 'ar' ? globalStore?.showroom_data?.store_regions?.name_arabic : globalStore?.showroom_data?.store_regions?.name} | {params.lang == 'ar' ? 'المملكة العربية السعودية' : 'Saudi Arabia'}</p>
                                                                                    <div className="mt-3">
                                                                                        <p
                                        ...
                                        return (
                                            <div key={addressData?.id + 1}>
                                                ...
                                                <div className="flex items-center gap-x-2 mt-1 rtl:mt-2 text-[#004B7A] fill-[#004B7A] font-regular text-xs">
                                                    ...
                                                    <div>
                                                        <p className="font-bold mb-1.5">{data.address_label == 0 ? params.lang == 'ar' ? 'الــمنـــزل' : 'Home' : params.lang == 'ar' ? 'مكتب' : 'Office'}</p>
                                    ...
                                    <>
                                        <div key={globalStore?.id + 1}>
                                            ...
                                            <div className="flex items-center gap-x-2 mt-1 rtl:mt-2 text-[#004B7A] fill-[#004B7A] font-regular text-xs">
                                                <svg id="fi_3514361" height="28" viewBox="0 0 256 256" width="28" xmlns="http://www.w3.org/2000/svg" data-name="Layer 1"><path d="m128 138.184a5 5 0 0 1 -3.607-1.538c-2.075-2.16-50.808-53.259-50.808-82.228a54.415 54.415 0 1 1 108.83 0c0 28.969-48.733 80.068-50.808 82.228a5 5 0 0 1 -3.607 1.538zm0-128.184a44.465 44.465 0 0 0 -44.415 44.418c0 19.07 29.312 54.978 44.414 71.451 15.1-16.478 44.416-52.4 44.416-71.451a44.465 44.465 0 0 0 -44.415-44.418z"></path><path d="m128 76.153a21.735 21.735 0 1 1 21.735-21.735 21.759 21.759 0 0 1 -21.735 21.735zm0-33.47a11.735 11.735 0 1 0 11.735 11.735 11.748 11.748 0 0 0 -11.735-11.735z"></path><path d="m128.126 256a4.992 4.992 0 0 1 -2.5-.67l-77.175-44.559a5 5 0 0 1 -2.5-4.331v-38.385a5 5 0 0 1 10 0v35.5l72.175 41.67 72.174-41.67v-35.88a5 5 0 0 1 10 0v38.765a5 5 0 0 1 -2.5 4.331l-77.174 44.556a4.992 4.992 0 0 1 -2.5.673z"></path><path d="m128.126 166.884a4.992 4.992 0 0 1 -2.5-.67l-77.175-44.557a5 5 0 1 1 5-8.66l74.675 43.113 74.674-43.11a5 5 0 1 1 5 8.66l-77.174 44.557a4.992 4.992 0 0 1 -2.5.667z"></path><path d="m160.933 198.291a5 5 0 0 1 -3.459-1.389l-32.806-31.402a5 5 0 0 1 6.916-7.224l30.1 28.813 68.154-39.349-27.558-26.382-27.359-15.744a5 5 0 1 1 4.988-8.667l27.885 16.047a4.988 4.988 0 0 1 .964.721l32.806 31.407a5 5 0 0 1 -.958 7.942l-77.174 44.557a4.993 4.993 0 0 1 -2.499.67z"></path><path d="m95.067 198.525a4.985 4.985 0 0 1 -2.5-.67l-77.173-44.555a5 5 0 0 1 -.957-7.942l33.057-31.642a4.967 4.967 0 0 1 .957-.718l27.634-15.955a5 5 0 1 1 5 8.66l-27.112 15.653-27.807 26.616 68.154 39.348 30.349-29.048a5 5 0 1 1 6.914 7.224l-33.058 31.641a4.991 4.991 0 0 1 -3.458 1.388z"></path></svg>
                                                <div>
                                                    <p className="font-medium text-xs">{params?.lang == 'ar' ? globalStore?.showroom_arabic : globalStore?.showroom}</p>
                                                    <label className="">{params?.lang == 'ar' ? globalStore?.showroom_address_arabic : globalStore?.showroom_address} | 8002444464</label>
                                                    <p className="font-medium text-xs">{params.lang == 'ar' ? globalStore?.waybill_city_data?.name_arabic : globalStore?.waybill_city_data?.name}, {params.lang == 'ar' ? globalStore?.showroom_data?.store_regions?.name_arabic : globalStore?.showroom_data?.store_regions?.name} | {params.lang == 'ar' ? 'المملكة العربية السعودية' : 'Saudi Arabia'}</p>
                                                </div>
                                            </div>
                                            {cartData?.storeType == 0 && cartData?.storeId == false && (
                                                <hr className="opacity-10 my-3" />
                                    ...
                                    <>
                                        ...
                                        <>
                                            <div className="text-sm font-medium">
                                                ...
                                                <div className="flex items-center gap-x-2 mt-1 rtl:mt-2 text-[#004B7A] font-regular text-xs">
                                                    <label className="">{dayjs().add(expressDeliveryData?.data?.num_of_days, 'days').locale(params.lang == 'ar' ? 'ar' : 'en').format("MMM  DD, YYYY")}</label>
                                                </div>
                                            </div>
                                        </>
                                        :
                                            <div className="text-sm font-medium">
                                                ...
                                                <div className="flex items-center gap-x-2 mt-1 rtl:mt-2 text-[#004B7A] font-regular text-xs">
                                                    <label className="">{dayjs().add(7, 'days').locale(params.lang == 'ar' ? 'ar' : 'en').format("MMM  DD, YYYY")}</label>
                                                </div>
                                ...
                                :null}
                                    ...
                                    {/* {paymentMethod != 'loyalty' ? 
                                        ...
                                        <div className="text-sm font-medium flex items-center justify-between">
                                            <div>
                                                <label className="font-regular text-[#5D686F]">{params.lang == 'ar' ? 'الدفع عن طريق' : 'Payment via'}{' '}<span className="font-bold text-[#004B7A] capitalize">{paymentMethod}</span></label>
                                                <div className="flex items-center gap-x-2 mt-1 rtl:mt-2 text-[#004B7A] text-xs">
                                                    <label>
                                                        {
                                                            paymentMethod == 'tamara' ? params.lang == 'ar' ? `غدا تقسيط علي 12 شهر بمبلغ ${Intl.NumberFormat('en-US').format(summary?.filter((element: any) => element.key == 'total')[0]?.price / 12)} ريال في الشهر` : `Installments for 12 months at an amount of ${Intl.NumberFormat('en-US').format(summary?.filter((element: any) => element.key == 'total')[0]?.price / 12)} per month`
                                                                : paymentMethod == 'tabby' ? params.lang == 'ar' ? `غدا تقسيط علي 4 شهر بمبلغ ${Intl.NumberFormat('en-US').format(summary?.filter((element: any) => element.key == 'total')[0]?.price / 4)} ريال في الشهر` : `Installments for 4 months at an amount of ${Intl.NumberFormat('en-US').format(summary?.filter((element: any) => element.key == 'total')[0]?.price / 4)} per month`
                                                                    : paymentMethod == 'madfu' ? params.lang == 'ar' ? `غدا تقسيط علي 4 شهر بمبلغ ${Intl.NumberFormat('en-US').format(summary?.filter((element: any) => element.key == 'total')[0]?.price / 4)} ريال في الشهر` : `Installments for 4 months at an amount of ${Intl.NumberFormat('en-US').format(summary?.filter((element: any) => element.key == 'total')[0]?.price / 4)} per month`
                                                                        : paymentMethod == 'mispay' ? params.lang == 'ar' ? `غدا تقسيط علي 4 شهر بمبلغ ${Intl.NumberFormat('en-US').format(summary?.filter((element: any) => element.key == 'total')[0]?.price / 4)} ريال في الشهر` : `Installments for 4 months at an amount of ${Intl.NumberFormat('en-US').format(summary?.filter((element: any) => element.key == 'total')[0]?.price / 4)} per month`
                                                                            : paymentMethod == 'clickpay' ? params.lang == 'ar' ? `غدا تقسيط علي 4 شهر بمبلغ ${Intl.NumberFormat('en-US').format(summary?.filter((element: any) => element.key == 'total')[0]?.price / 4)} ريال في الشهر` : `Installments for 4 months at an amount of ${Intl.NumberFormat('en-US').format(summary?.filter((element: any) => element.key == 'total')[0]?.price / 4)} per month`
                                                                                : paymentMethod == 'tasheel' ? params.lang == 'ar' ? `غدا تقسيط علي 36 شهر بمبلغ ${Intl.NumberFormat('en-US').format(summary?.filter((element: any) => element.key == 'total')[0]?.price / 36)} ريال في الشهر` : `Installments for 36 months at an amount of ${Intl.NumberFormat('en-US').format(summary?.filter((element: any) => element.key == 'total')[0]?.price / 36)} per month`
                                    ...
                                    <div className="mt-2 text-[#004B7A] font-regular text-xs bg-white p-3 shadow-md rounded-md border border-[#219EBC] flex items-center justify-between gap-x-4">
                                        <div className="flex items-center gap-x-4">
                                            ...
                                            <div className="font-bold">
                                                ...
                                                <span className="text-xs font-medium text-[#5D686F]">{params.lang == 'ar' ? 'من المتوقع أن يتم التسليم يوم' : 'Delivery is expected to take place on'} <span className="font-bold">{dayjs().add(2, 'days').locale(params.lang == 'ar' ? 'ar' : 'en').format("MMM  DD, YYYY")}</span></span>
                                                        ...
                                                        <div>
                                                            {pro.pre_order ?
                                                                <>
                                                                    ...
                                                                    <p className="text-sm text-primary font-medium">{params?.lang === 'ar' ? 'سلمت بواسطة' : 'Delivered by'}: {dayjs().add(pro.pre_order_day, 'days').locale(params.lang == 'ar' ? 'ar' : 'en').format("MMM DD, YYYY")}</p>
                                                                </>
                                                                : null}
                                        ...
                                                        </>
                                                    ...
                                                    <div className='flex items-center gap-x-4 my-2'>
                                                        ...
                                                        <div className='text-xs font-normal'>
                                                            <h6 className='font-semibold text-sm'>{params?.lang == "ar" ? "ومن المتوقع أن يتم التسليم في " : "Delivery is expected to take place on " + dayjs().add(1, 'days').format('DD MMM')} {dayjs().add(5, 'days').format('DD MMM')}</h6>
                                                            ...
                                                            <div className={`bg-[#EEF8FC] shadow-md rounded-md p-3`} key={i * 4}>
                                                                ...
                                                                {(pro.express && pro?.express_qty >= pro?.quantity) && giftData.express && giftData?.express_qty >= giftData?.quantity ?
                                                                    ...
                                                                    <div className='flex items-center gap-x-4'>
                                                                        ...
                                                                        <div className='text-xs font-normal'>
                                                                            <h6 className='font-semibold text-sm'>{params?.lang == "ar" ? "احصل عليه خلال 24 ساعة" : "Delivery is expected to take place on " + dayjs().add(1, 'days').format('DD MMM')} {dayjs().add(5, 'days').format('DD MMM')}</h6>
