...
export default function HomePageProductThumbnail(props: any, request: any) {
        ...
        <>
            <div className="relative pb-2 grid grid-cols-2 gap-2">
                {Array.from(props?.products).slice(0, 4)?.map((data: any, i: any) => {
                    ...
                    return (
                        <div className="bg-white relative p-1 md:p-2 rounded-lg shadow-md cursor-pointer !h-full self-stretch overflow-hidden" key={i}>
                            <Link
                            ...
                            >
                                ...
                                : moment(d2).diff(d1, 'days') <= data.newtype ?
                                    ...
                                    : data.best_seller == 1 ?
                                        ...
                                        : data.top_selling == 2 ?
                                            <div className='text-[#0B5ED8] text-[0.55rem] lg:text-xs absolute ltr:left-0 rtl:right-0 top-0 bg-[#0B5ED820] md:px-3.5 px-2 py-1 rtl:rounded-bl-lg rtl:rounded-tr-lg ltr:rounded-br-lg ltr:rounded-tl-lg'>{props.lang == 'ar' ? 'أكثر مبيعا' : 'Top Selling'}</div>
                                            : data.low_in_stock == 3 ?
                                                <div className='text-[#F0660C] text-[0.55rem] lg:text-xs absolute ltr:left-0 rtl:right-0 top-0 bg-[#F0660C20] md:px-3.5 px-2 py-1 rtl:rounded-bl-lg rtl:rounded-tr-lg ltr:rounded-br-lg ltr:rounded-tl-lg'>{props.lang == 'ar' ? 'كمية محدودة' : 'Low in Stock'}</div>
                                                : null}
                                {data?.custom_badge_en || data?.custom_badge_ar ?
                                        <>
                                            <div className='text-[#EA4335] text-[0.55rem] md:text-xs absolute ltr:right-0 rtl:left-0 top-0 bg-[#EA433520] md:px-3.5 px-2 py-1 rtl:rounded-tl-lg rtl:rounded-br-lg ltr:rounded-bl-lg ltr:rounded-tr-lg'>
                                        ...
                                        <>
                                            ...
                                            {data?.sale_price ?
                                                <div className='text-[#EA4335] text-[0.55rem] md:text-xs absolute ltr:right-0 rtl:left-0 top-0 bg-[#EA433520] md:px-3.5 px-2 py-1 rtl:rounded-tl-lg rtl:rounded-br-lg ltr:rounded-bl-lg ltr:rounded-tr-lg flex gap-x-1 items-center'>
                                                    {data?.savetype == 1 ?
                                                        props.lang == 'ar' ? 'خصم %' +
                                ...
                                <Image
                                    ...
                                    height={props?.devicetype === 'mobile' ? 150 : 180}
                                    width={props?.devicetype === 'mobile' ? 150 : 180}
                                    loading='lazy'
                            ...
                            <div className="flex items-center justify-between absolute bottom-2">
                                <div className=''>
                                    <div className='text-primary font-semibold line-clamp-2 text-xs'>{props.lang == 'ar' ? data?.name_arabic : data?.name}</div>
                                    <div className='text-primary text-xs flex items-center gap-x-2 mt-2'>
                                        ...
                                        {data?.brand?.brand_media_image ?
                                            <Image
                                                ...
                                                alt={(data?.brand?.brand_media_image?.alt_arabic && props?.lang == 'ar') ? data?.brand?.brand_media_image?.alt_arabic : (data?.brand?.brand_media_image?.alt && props?.lang == 'en') ? data?.brand?.brand_media_image?.alt : ''}
                                                title={(data?.brand?.brand_media_image?.title_arabic && props?.lang == 'ar') ? data?.brand?.brand_media_image?.title_arabic : (data?.brand?.brand_media_image?.title && props?.lang == 'en') ? data?.brand?.brand_media_image?.title : ''}
                                                height={0}
                                                width={0}
                                                loading='lazy'
                                    ...
                                    <div className='flex items-end gap-2 -mt-1'>
                                        <p className='font-bold text-sm text-[#DC4E4E] max-sm:leading-3 flex gap-1 items-center'>
                                        ...
                                        {data?.sale_price ?
                                            <small className='text-dark line-through text-xs font-medium decoration-[#DC4E4E]'>
                                                {ProExtraData[data?.id]?.flash && data?.price && !data?.sale_price ?
                                                    ProExtraData[data?.id]?.flash?.discount_type === 2 ? Math.round(data?.price * ProExtraData[data?.id]?.flash?.discount_amount / 100).toLocaleString('EN-US') :
                                                        ProExtraData[data?.id]?.flash?.discount_amount :
                                                    data?.price.toLocaleString('EN-US')}
                                            </small> : null}
                                    </div>
                                </div>
                                <div className='flex items-center justify-between gap-x-1 absolute rtl:left-0 ltr:right-0 -bottom-2'>
                                    {data?.pre_order == 1 ?
                                        <>
                                            <button className='bg-primary focus-visible:outline-none text-white flex items-center justify-center px-2 py-2 gap-x-1 rtl:rounded-bl-md ltr:rounded-br-md md:h-10 h-8 w-full'
                                            ...
                                            >
                                                {buyNowLoading == data?.id ?
                                                    <svg height="20" viewBox="0 0 24 24" className="animate-spin h-6 w-6 mr-3 fill-white" width="20" xmlns="http://www.w3.org/2000/svg" id="fi_7235860"><path d="m12 22c5.421 0 10-4.579 10-10h-2c0 4.337-3.663 8-8 8s-8-3.663-8-8c0-4.336 3.663-8 8-8v-2c-5.421 0-10 4.58-10 10 0 5.421 4.579 10 10 10z"></path></svg>
                                                    :
                                                    <>
                                                        <svg id="fi_3144456" enableBackground="new 0 0 511.728 511.728" height="16" viewBox="0 0 511.728 511.728" width="16" xmlns="http://www.w3.org/2000/svg" fill="#FFFFFF">
                                        ...
                                        :
                                        <button className={`focus-visible:outline-none text-white flex items-center justify-center px-2 py-2 gap-x-1 rtl:rounded-bl-md ltr:rounded-br-md md:h-10 h-8 w-full ${data?.quantity == 0 || data?.quantity == null ? true : false || checkQty ? 'bg-primary/50' : 'bg-primary'}`}
                                                    ...
                                                    <div className="flex items-center w-full md:gap-2 mt-2 md:mt-0" key={i}>
                                                        ...
                                                        <div className="w-full">
                                                            ...
                                                            <h4 className="mt-1 text-sm  font-bold text-dark">
                                                                <>
                                                                    {props.lang == 'ar' ? fbtprice + ' ر.س' : 'SR ' + fbtprice}{'  '}
                                                                    <span className="text-[0.65rem] text-[#DC4E4E] line-through decoration-[#DC4E4E] decoration-2 font-medium">{props.lang == 'ar' ? (fbtpro?.productdetail?.price + ' ر.س') : 'SR ' + fbtpro?.productdetail?.price}</span>
                                                                </>
                                                            </h4>
                                                        </div>
                                                    </div>
