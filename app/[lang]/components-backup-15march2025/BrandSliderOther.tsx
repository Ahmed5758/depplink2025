                    ...
                    <div className="flex flex-nowrap items-center">
                        {BrandData?.map((data: any, i: React.Key | null | undefined) => {
                            return (
                                ...
                                >
                                    <Image
                                        src={data?.brand_media_image ? NewMedia + data?.brand_media_image?.image : 'https://partners.tamkeenstores.com.sa/public/assets/new-media/3f4a05b645bdf91af2a0d9598e9526181714129744.png'}
