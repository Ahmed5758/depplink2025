...
export async function generateMetadata({ params }: Props, parent: ResolvingMetadata): Promise<Metadata> {
    return {
        title: 'Reset Password | Tamkeen Stores',
        description: 'qaiser',
        ...
        openGraph: {
            siteName: `Reset Password | Tamkeen Stores`,
            title: `Reset Password | Tamkeen Stores`,
            description: '',
            locale: params.lang,
            type: 'website',
...
export default async function resetPasswordLayout({ children, params }: { children: React.ReactNode, params: {slug: string, data: any, lang: string } }) {
    const jsonLd = [
        {
            "@id": "#breadcrumb",
            ...
            itemListElement: [
                ...
                },
                {
                    ...
                    position: 2,
                    name: "resetPassword",
                    item: "https://tamkeenstores.com.sa/" + params.lang + "/resetpassword",
                },
            ],
        },
    ]
