...
export default function ProductSliderNew(props: any) {
    ...
    const topMessageAlartDanger = (title: any) => {
        MySwal.fire({
            ...
            ,
            toast: true,
            position: props.lang ? 'top-start' : 'top-end',
        ...
        MySwal.fire({
            ...
            title:
                <div className="text-xs">
                    ...
                    {viewcart ?
                        <>
                            <p className="font-light mb-3">{props.lang ? 'تمت إضافة العنصر إلى سلة التسوق الخاصة بك.' : 'The item has been added into your cart.'}</p>
                            <button
                                onClick={() => {
                                ...
                                {props.lang ? 'عرض العربة' : 'View Cart'}
                            </button>
                        </>
                        : null}
                </div>
    ...
    const sliderHeading = props?.title
                                    ...
                                    <div className=''>
                                        ...
                                        <div className='flex items-center'>
                                            ...
                                            <h4 className='text-sm'>
                                                <DiscountLabel isSale={saleType} discountPercentage={percentageAmount} regPrice={getFormattedPrice(getOriginalPrice())} salePrice={productSalePrice} />
                                            </h4>
                                        </div>
    ...
    return (
        <>
            <div className="align__center mb-2">
                <h2 className="headingHomeMain !text-xl">{sliderHeading}</h2>
                <div className="flex gap-4 items-center">
                    <div>
                        <button className="text-sm underline text-primary font-semibold"
                            onClick={() => {
                                router.push(`${origin}/${lang}/${props?.buttonLink}`)
                            }}
                        >
                            {props?.showAllTitle}
                        </button>
                    ...
                    <div className='flex items-center gap-1'>
                        <button aria-label="Previous" className={`${isArabic ? 'rotate-180' : null} cursor-pointer fill-dark arrow-right-${props?.sec} arrow p-2.5 bg-dark/20 rounded-full`}>
                        ...
                        <button aria-label="Next" className={`${isArabic ? 'rotate-180' : null} cursor-pointer fill-dark arrow-left-${props?.sec} arrow p-2.5 bg-dark/20 rounded-full`}>
                            <svg height="14" viewBox="0 0 24 24" width="14" xmlns="http://www.w3.org/2000/svg" id="fi_10486749" className="fill-current transform transition duration-150 ease-in-out -rotate-90"><path clipRule="evenodd" d="m2.58579 7.58579c.78104-.78105 2.04738-.78105 2.82842 0l6.58579 6.58581 6.5858-6.58581c.781-.78105 2.0474-.78105 2.8284 0 .7811.78104.7811 2.04738 0 2.82841l-8 8c-.781.7811-2.0474.7811-2.8284 0l-8.00001-8c-.78105-.78103-.78105-2.04737 0-2.82841z" fillRule="evenodd"></path></svg>
                        </button>
                    </div>
                </div>
