...
export default function HomeStyleVideoSection(props: any) {
    ...
    const imageSrc = `${isArabic ? NewMedia2 + props?.data?.sec8_secondary_image_ar : NewMedia2 + props?.data?.sec8_secondary_image}`;
    const imageSrc2 = `${isArabic ? NewMedia2 + props?.data?.sec8_first_vedio_ar : NewMedia2 + props?.data?.sec8_first_vedio}`;
    return (
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            {props?.data?.sec8_first_vedio || props?.data?.sec8_first_vedio_ar ?
