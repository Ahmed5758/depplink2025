            ...
            {props.type === "Secondary" && (
                <div className="fixed top-0 z-40 w-full">
                    <div className="bg-white shadow-md py-3.5 px-2 flex items-center justify-between">
                        ...
                        <h1 className="heading__base line-clamp-1">{props.pageTitle}</h1>
            ...
            {props.type === "Third" && (
                <div className="bg-white shadow-md py-3.5 fixed top-0 z-40 w-full px-2 flex items-center">
                    <button className="w-16" onClick={goBack}>
                        <svg height="30" width="30" viewBox="0 0 24 24" className={props.lang === 'ar' ? 'rotate-180' : ''}><path d="m15 19a1 1 0 0 1 -.71-.29l-6-6a1 1 0 0 1 0-1.41l6-6a1 1 0 0 1 1.41 1.41l-5.29 5.29 5.29 5.29a1 1 0 0 1 -.7 1.71z" /></svg>
                    </button>
                    <h1 className="text-lg font-bold text-center w-64 line-clamp-1">{props.pageTitle}</h1>
                </div>
            )}

            {props.type === "Product" && (
                <div className="bg-white shadow-md py-3.5 fixed top-0 z-40 w-full px-2 flex items-center justify-between">
                    <button className="w-16" onClick={() => { router.back(); router.refresh() }}>
                        <svg height="30" width="30" viewBox="0 0 24 24" className={props.lang === 'ar' ? 'rotate-180' : ''}><path d="m15 19a1 1 0 0 1 -.71-.29l-6-6a1 1 0 0 1 0-1.41l6-6a1 1 0 0 1 1.41 1.41l-5.29 5.29 5.29 5.29a1 1 0 0 1 -.7 1.71z" /></svg>
                    </button>
