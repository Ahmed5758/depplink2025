...
export default function BestProductsMobile(props: any) {
    ...
    const currencySymbol = isArabic ? ' ر.س' : ' SR';
    return (
        <>
                                                ...
                                                >
                                                            ...
                                                            {data?.sale_price ?
                                                                <div className='text-[#EA4335] text-[0.55rem] md:text-xs absolute ltr:right-0 rtl:left-0 top-0 bg-[#EA433520] md:px-3.5 px-2 py-1 rtl:rounded-tl-lg rtl:rounded-br-lg ltr:rounded-bl-lg ltr:rounded-tr-lg z-20'>
                                                                    {data?.savetype == 1 ?
                                                                        ...
                                                                        :
                                                                        props.lang == 'ar' ? 'وفر ' + (data.price - flashCalc).toLocaleString('EN-US') + ' ر.س' : 'Save ' + (data.price - flashCalc).toLocaleString('EN-US') + ' SR'
                                                                    }
                                                                </div>
                                                                : null}
                                                        </>
                                                    ...
                                                    <div className='text-primary text-xs flex items-center gap-x-2'>
                                                        ...
                                                        {data?.brand?.brand_media_image ?
                                                            <Image
                                                                ...
                                                                width={80}
                                                                loading='lazy'
                                                                sizes='(max-width: 640px) 100vw, (max-width: 768px) 100vw, (max-width: 1024px) 100vw, 80px'
                                                            />
                                                            :
                                                    ...
                                                    <div className='md:flex md:items-end md:gap-x-2 mt-2.5 md:mt-1.5 ltr:text-left rtl:text-right'>
                                                        {data?.promotional_price > 0 ?
                                                            <>
                                                                <p className='font-bold text-lg lg:text-xl text-[#DC4E4E] max-sm:leading-3'>
                                                                    {ProExtraData[data?.id]?.flash && data?.sale_price ?
                                                                        ...
                                                                        data?.sale_price ? Math.round(data?.sale_price - data?.promotional_price).toLocaleString('EN-US') : data?.price.toLocaleString('EN-US')} {props.dict?.sr}
                                                                </p>
                                                            </>
                                                            :
                                                            <>
                                                                <p className='font-bold text-lg lg:text-xl text-[#DC4E4E] max-sm:leading-3'>
                                                                    {ProExtraData[data?.id]?.flash && data?.sale_price ?
                                                                        ProExtraData[data?.id]?.flash?.discount_type === 2 ? Math.round(data?.sale_price * ProExtraData[data?.id]?.flash?.discount_amount / 100).toLocaleString('EN-US') :
                                                                            ProExtraData[data?.id]?.flash?.discount_amount :
                                                                        data?.sale_price ? data?.sale_price.toLocaleString('EN-US') : data?.price.toLocaleString('EN-US')} {props.dict?.sr}
                                                                </p>
                                                            </>
                                                        }
                                                                    ...
                                                                    <div className="flex w-full items-center justify-between">
                                                                        <div className="flex items-center gap-x-3">
                                                                            <Image
                                                                                ...
                                                                                sizes='(max-width: 640px) 100vw, (max-width: 768px) 100vw, (max-width: 1024px) 100vw, 260px'
                                                                            />
