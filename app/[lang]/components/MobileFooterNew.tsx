...
export default function MobileFooterNew(props: any) {
  ...
  const categoriesIcon: any = (
    <svg width="24" height="24" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
      <rect x="0.902778" y="0.902778" width="9.75" height="9.75" stroke="currentColor" stroke-width="1.80556"/>
      <rect x="15.3471" y="0.902778" width="9.75" height="9.75" stroke="currentColor" stroke-width="1.80556"/>
      <rect x="0.902778" y="15.3471" width="9.75" height="9.75" stroke="currentColor" stroke-width="1.80556"/>
      <rect x="15.3471" y="15.3471" width="9.75" height="9.75" stroke="currentColor" stroke-width="1.80556"/>
    </svg>
  );
  ...
  const generalSupreme: any = (
    <svg width="40" height="25" viewBox="0 0 42 26" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M39.839 4.61175L41.59 0.119263H23.7173L21.9619 4.61175H39.839Z" fill="currentColor"/>
      <path d="M39.8968 4.70016H21.834L23.6602 0.00427246H41.7451L39.8968 4.70016ZM22.0905 4.52329H39.7775L41.4621 0.203243H23.7751L22.0905 4.52329Z" fill="currentColor"/>
      <path d="M4.73938 13.0262C4.73938 8.37449 8.48456 4.60275 13.1053 4.60275H20.3967L22.1478 0.105835H13.3264C13.2733 0.105835 13.2158 0.105835 13.1628 0.105835C6.10125 0.105835 0.357422 5.88948 0.357422 13.0041C0.357422 20.1186 6.10125 25.9023 13.1628 25.9023C13.9852 25.9023 14.7856 25.8227 15.5638 25.6724L17.7658 20.0214C16.4349 20.9234 14.8298 21.454 13.1009 21.454C8.48014 21.454 4.73496 17.6823 4.73496 13.0306L4.73938 13.0262Z" fill="currentColor"/>
      <path d="M13.1629 25.9998C6.04832 25.9998 0.255859 20.1676 0.255859 12.9999C0.255859 5.83228 6.04389 0 13.1629 0C13.1939 0 13.2248 0 13.2602 0C13.269 0 13.2735 0 13.2823 0H13.3309H22.2982L20.4676 4.69589H13.1098C8.55103 4.69589 4.8412 8.43227 4.8412 13.022C4.8412 17.6118 8.55102 21.3482 13.1054 21.3482C14.7547 21.3482 16.351 20.8574 17.7129 19.9332L17.9782 19.7519L15.6391 25.7567L15.586 25.7655C14.7901 25.9203 13.9765 25.9954 13.1629 25.9954V25.9998ZM13.1629 0.207822C6.15886 0.207822 0.459242 5.94725 0.459242 13.0043C0.459242 20.0615 6.15886 25.8009 13.1629 25.8009C13.9411 25.8009 14.7238 25.7301 15.4932 25.5842L17.5626 20.2737C16.2228 21.1094 14.6884 21.5516 13.1054 21.5516C8.43606 21.5516 4.64219 17.7268 4.64219 13.0265C4.64219 8.32614 8.44048 4.50133 13.1054 4.50133H20.3306L22.002 0.207822H13.3928H13.3221C13.3 0.207822 13.2735 0.207822 13.2514 0.207822C13.2204 0.207822 13.1894 0.207822 13.1629 0.207822Z" fill="currentColor"/>
      <path d="M34.9176 25.9114L36.6686 21.4189H18.7959L17.0449 25.9114H34.9176Z" fill="currentColor"/>
      <path d="M34.9799 26H16.917L18.7387 21.3307H36.8016L34.9799 26ZM17.1735 25.8232H34.8605L36.5451 21.5031H18.8581L17.1735 25.8232Z" fill="currentColor"/>
      <path d="M37.3273 10.7231H19.4502L21.2057 15.2156H35.5852L37.3318 19.7125L39.0783 15.2156L37.3273 10.7231Z" fill="currentColor"/>
      <path d="M37.3326 19.9862L35.5197 15.3169H21.1402L19.3096 10.621H37.3989L39.1897 15.2152L37.337 19.9862H37.3326ZM21.2729 15.1179H35.6567L37.337 19.4379L38.9775 15.2196L37.2663 10.8244H19.6058L21.2772 15.1179H21.2729Z" fill="currentColor"/>
      <rect x="10.0195" y="11.5498" width="9.00267" height="9.00267" fill="url(#pattern0_1_22120)"/>
      <defs>
      <pattern id="pattern0_1_22120" patternContentUnits="objectBoundingBox" width="1" height="1">
  ...
  const navItems = [
    ...
    {
      label: props?.lang == 'ar' ? "جنرال سوبريم" : "General",
            ...
            {navItems?.map((item, index) => (
              ...
              >
                ...
                >
                  ...
                  {activeIndex === index && (
                    <span className="absolute duration-300 ease-in-out bottom-0 mb-2 w-[65%] h-[3px] rounded-t-full bg-[#004b7a]" style={{boxShadow: '0 -2px 2.5px 0.5px #f8be98'}}></span>
                  )}
                </button>
              </li>
            ))}
